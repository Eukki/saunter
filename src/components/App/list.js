import React, { Cmoponent } from 'react';
...
export const list = paths => {
    paths.map((path, i) => {
        return (
          <a href="#" id={path.id} className="list-group-item list-group-item-action flex-column align-items-start mh-150 overflow-hidden" onClick={(e) => setActive(e, path)} key={i}>
            <div className="d-flex w-100 justify-content-between">
              <h5 className="mb-1 overflow-hidden">
                
                <div className={path.isPrimary ? "min-w-15 mr-2" : "hidden">
